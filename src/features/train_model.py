...
y_train.value_counts().plot(kind="bar", ax=ax, color="lightblue", label="Total")
y_test.value_counts().plot(kind="bar", ax=ax, color="lightpink", label="Total")
plt.legend()
plt.show()
# --------------------------------------------------------------
...
feature_set_2 = list(set(basic_features + pca_features + square_features))
