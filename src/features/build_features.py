...
for s in df["set"].unique():
    ...
    # In pandas, when you assign a value to a column that doesn't exist, pandas will create that column.
...
fs = int(1000 / 200)
ws = int(2800 / 200)  # avg set time

df_dreq = FreqAbs.abstract_frequency(df_freq, ["acc_y"], ws, fs)
